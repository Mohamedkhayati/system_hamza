...
$search = isset($_GET['search-name']) ? $_GET['search-name'] : '';
$query = "SELECT id, name, number, age, start_date, end_date, active, photo FROM subscribers WHERE name LIKE ?";
...
<form method="GET" style="text-align:center; margin-bottom: 20px;">
    <input type="text" name="search-name" placeholder="Search by name" value="<?= htmlspecialchars($search) ?>">
